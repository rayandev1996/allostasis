    ...
    Profile: {
      ...
      posts: {
        ...
        relation: {
          ...
          model:
            'kjzl6hvfrbw6c9mslqhkfkowfxi91ozmaj8z4km8u7oifu1z0qdk3rycyf0cdei',
          property: 'profileID'
        }
      },
      postsCount: {
      ...
      articles: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6cbas44439gp7m1dksfv2bk0yvx1p7i6v2f7rmhnqp0j6jncixum',
          property: 'profileID'
        }
      },
      articlesCount: {
      ...
      assets: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c7b7ogar0vuj6mltz82y644vt869k4b62xkb22ubccvoqtmvmt6',
          property: 'profileID'
        }
      },
      assetsCount: {
    ...
    Post: {
      ...
      profile: {
        ...
        relation: {
          source: 'document',
          model:
            'kjzl6hvfrbw6c688dmvwdp0xxamkmi0pdo9cb24xur143qzb05dv60xv9yxwd12',
          property: 'profileID'
        }
      },
      comments: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c6zytfh480ub35wmpkxayxkfly49sfo86piwk645sczn2n13r41',
          property: 'postID'
        }
      },
      commentsCount: {
      ...
      likes: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c8bd6vafqifuli7aa2vxs42bi1dupdeaspflik5jy2d28jseigj',
          property: 'postID'
        }
      },
      likesCount: {
    ...
    Article: {
      ...
      comments: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c5lvhejwop93r06umggj8m2aaw2o2elflzdf5aqthb98wgfbf81',
          property: 'articleID'
        }
      },
      commentsCount: {
      ...
      likes: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c8uc1ispov6mx5zoooszn7gtiprfnrcztbz1l1z23l6bb6b8vpr',
          property: 'articleID'
        }
      },
      likesCount: {
