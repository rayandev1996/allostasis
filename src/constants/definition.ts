    ...
    Profile: {
      ...
      articles: {
        ...
        relation: {
          ...
          model:
            'kjzl6hvfrbw6cankvgnn9dluhh057jp3wo515fefblyfd2ew6ngis7o34gkxbv2',
          property: 'profileID'
        }
      },
      articlesCount: {
    ...
    Article: {
      ...
      comments: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c9mga4hz9i53yr79s8sjpd7cz57jpqxgm0y2tavi2y7nxvfy3nc',
          property: 'articleID'
        }
      },
      commentsCount: {
      ...
      likes: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6cbcts0egi1fr8uapw71hcjqu7o1wr2lcdbc25qa5ep3ii2r6xxi',
          property: 'articleID'
        }
      },
      likesCount: {
      ...
      permissionRequests: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c62434jskboy25bm25a5ym5ni0bzoxrmmgsd4lo3rlbziuyiwa5',
          property: 'articleID'
        }
      }
    },
    ...
    ArticlePermissionRequest: {
      ...
      status: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c6uabt6althg6t71dcs86hglyhqz2jtmzfv7er279wjsdn07yi8',
