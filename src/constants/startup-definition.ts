    ...
    Profile: {
      ...
      posts: {
        ...
        relation: {
          ...
          model:
            'kjzl6hvfrbw6c8j1xnrhqu79ho3uf5bz42qfyrqlyfbncp88fwg5aj5ljes9n3k',
          property: 'profileID'
        }
      },
      postsCount: {
      ...
      articles: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6cba691bhbzx4aemrgvqh2e8uviz9amvs7phow7fbbwjpg66g5x8',
          property: 'profileID'
        }
      },
      articlesCount: {
      ...
      assets: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6cag11nmzu4qzd279uxzccv6vtiajps40wsnq5f5b611irgo3tty',
          property: 'profileID'
        }
      },
      assetsCount: {
    ...
    Asset: {
      ...
      profile: {
        ...
        relation: {
          source: 'document',
          model:
            'kjzl6hvfrbw6c7e8vhd2cc6yklpsxb7hgk6o3g0fdrx8xgjcbcbzd1imsvd6xph',
          property: 'profileID'
        }
      }
    },
    Article: {
      ...
      comments: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c9vyeo99ruds8pkdp7in075shwlm9lhrah4l5relel1ao3q3n56',
          property: 'articleID'
        }
      },
      commentsCount: {
      ...
      likes: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c6x9b590ugyyj76hw9764unhl72i5xza1tfg21eafx5ahoq40zz',
          property: 'articleID'
        }
      },
      likesCount: {
    ...
    Post: {
      ...
      comments: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c9y6agg85bfpfqdgmnj8if5f80pz3kobp9mp4hjhxpxcthq8v2g',
          property: 'postID'
        }
      },
      commentsCount: {
      ...
      likes: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c9b489k4sdozawhqyvy3zm20entzpu0kem5786gqxcr8ml9z4vt',
          property: 'postID'
        }
      },
      likesCount: {
