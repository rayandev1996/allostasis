    ...
    Profile: {
      ...
      posts: {
        ...
        relation: {
          ...
          model:
            'kjzl6hvfrbw6c9ygme40t294135bmkkugcjkaotqewsu83a02tzbcy1i6fyhc4f',
          property: 'profileID'
        }
      },
      postsCount: {
      ...
      articles: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6cafaywaha0gs6e4vvzs2gr9xyz9amryg74o5ww6vk7qemab4s0g',
          property: 'profileID'
        }
      },
      articlesCount: {
      ...
      assets: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6ca60n3puilridoe5aces94zovdny8d2f81x3f4b9skdvo8vtsnk',
          property: 'profileID'
        }
      },
      assetsCount: {
    ...
    Asset: {
      ...
      profile: {
        ...
        relation: {
          source: 'document',
          model:
            'kjzl6hvfrbw6c649vlt9aulg5ylaigtvz48y7hwcivzg0lr1r8cua8i1sgmhjo6',
          property: 'profileID'
        }
      }
    },
    Post: {
      ...
      comments: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c7h26tcqsadvi57fxbk2irfm9zpgxa3sp5equq93cylfpsjrm81',
          property: 'postID'
        }
      },
      commentsCount: {
      ...
      likes: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c7lyrirgtiaumocnwcv7xr7r7qbobv3zc5bhxreaqp0gq4nhjtj',
          property: 'postID'
        }
      },
      likesCount: {
    ...
    Article: {
      ...
      comments: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c77udwq03vm2kwuqsgofrbydl3bkktrakurhiyoyg3pntoy5gse',
          property: 'articleID'
        }
      },
      commentsCount: {
      ...
      likes: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6caohxgg54j5hk4o974y4wfhoppezsd8bwexa2woskt6c83fnxxx',
          property: 'articleID'
        }
      },
      likesCount: {
