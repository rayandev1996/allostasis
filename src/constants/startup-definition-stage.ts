    ...
    Profile: {
      ...
      posts: {
        ...
        relation: {
          ...
          model:
            'kjzl6hvfrbw6cb541m25odgp7fha6lorrl76pkcf1k93re7wn9xjaitecs97cya',
          property: 'profileID'
        }
      },
      postsCount: {
      ...
      articles: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6ca6t8cygucfvl03z6cycsnl68d2uhwfxoz3ff4mmimc88dd3l60',
          property: 'profileID'
        }
      },
      articlesCount: {
      ...
      assets: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c77onio048oogk8gg4v3lumwrn87vxx8p3qk6f2ydp6hj8f3rk4',
          property: 'profileID'
        }
      },
      assetsCount: {
    ...
    Post: {
      ...
      profile: {
        ...
        relation: {
          source: 'document',
          model:
            'kjzl6hvfrbw6c91jfefehmxvwnkduaajgxfwdqcsrpf0ngr7t0voq1zw7vasufm',
          property: 'profileID'
        }
      },
      comments: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6cb8b2wyabjypqywmwvgrdp55z7fehwdwu1kdia5e2mv1s2qifmx',
          property: 'postID'
        }
      },
      commentsCount: {
      ...
      likes: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c6rmyzf02jhvb4q06z4ptwl1syyxleknmj8ry434o59d4iouv6u',
          property: 'postID'
        }
      },
      likesCount: {
    ...
    Article: {
      ...
      comments: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c8uh70h0qdkli3zuwrklb2by40mqq2jj66co6p29war9qyck7yb',
          property: 'articleID'
        }
      },
      commentsCount: {
      ...
      likes: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6cb7si8021czj6b2madtntripf2wzo6vvm3yo3yx42ao2fseaip6',
          property: 'articleID'
        }
      },
      likesCount: {
