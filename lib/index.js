...
class Allostasis {
    constructor(community, options) {
        ...
        this.lit = new LitJsSdk.LitNodeClient({
            ...
            debug: (_a = options.debugLit) !== null && _a !== void 0 ? _a : false
        });
        if (options.infura) {
                    ...
                    if (authMethod != null) {
                        ...
                        this.ethersProvider
                            ...
                            const entropy = yield this.provider.request({
                                ...
                                params: [
                                    u8a.toString(u8a.fromString('Give this app permission to read or write your private data'), 'base16'),
                                    accounts[0]
                                ]
                            });
                            const seed = (0, sha256_1.hash)(u8a.fromString(entropy.slice(2), 'base16'));
