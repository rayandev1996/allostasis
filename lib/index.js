        ...
        return __awaiter(this, void 0, void 0, function* () {
          ...
          `);
                ...
                `);
                                    ...
                                    break;
                                case 'embodia':
                                    const createEmbodia = yield this.composeClient.executeQuery(`
                  mutation {
                ...
                `);
                                    if (createEmbodia.errors != null &&
                                        createEmbodia.errors.length > 0) {
                                        reject(createEmbodia);
                                    }
                                    else {
                                        resolve(Object.assign(Object.assign(Object.assign({}, create.data.createProfile.document), createEmbodia.data.createEmbodiaProfile.document), { id: create.data.createProfile.document.id, embodiaProfileId: createEmbodia.data.createEmbodiaProfile.document.id }));
                                    }
                                    break;
                                default:
        ...
        return __awaiter(this, void 0, void 0, function* () {
          ...
          `);
                  ...
                  `);
                                        ...
                                        break;
                                    case 'embodia':
                                        const embodiaProfile = yield this.composeClient.executeQuery(`
                    query {
                      viewer {
                        embodiaProfile {
                          id
                  ...
                  `);
                                        if (embodiaProfile.errors != null &&
                                            embodiaProfile.errors.length > 0) {
                                            reject(embodiaProfile);
                                        }
                                        else {
                                            if (((_m = (_l = embodiaProfile.data) === null || _l === void 0 ? void 0 : _l.viewer) === null || _m === void 0 ? void 0 : _m.embodiaProfile) != null) {
                                                resolve(Object.assign(Object.assign(Object.assign({}, profileData), (_p = (_o = embodiaProfile.data) === null || _o === void 0 ? void 0 : _o.viewer) === null || _p === void 0 ? void 0 : _p.embodiaProfile), { id: profileData.id, embodiaProfileId: (_r = (_q = embodiaProfile.data) === null || _q === void 0 ? void 0 : _q.viewer) === null || _r === void 0 ? void 0 : _r.embodiaProfile.id }));
                                            }
                                            else {
                                                reject(embodiaProfile);
                                            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            `);
                            if (embodiaProfile.errors != null &&
                                ...
                                const _b = embodiaProfile.data.node, { id } = _b, rest = __rest(_b, ["id"]);
                                resolve(Object.assign(Object.assign({}, rest), { embodiaProfileId: embodiaProfile.data.node.id }));
                            }
                            break;
                        default:
                            reject('Wrong Community');
